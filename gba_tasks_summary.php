...
<body class="min-h-screen">
    ...
    <div id="task-modal" class="fixed inset-0 z-[9999] flex items-center justify-center bg-black/75 backdrop-blur-sm hidden" style="backdrop-filter: blur(8px);">
        <div class="modal-content-wrapper glassmorphism-modal rounded-2xl shadow-2xl p-4 sm:p-5 w-full max-w-5xl mx-3 max-h-[92vh] overflow-y-auto" onclick="event.stopPropagation()">
